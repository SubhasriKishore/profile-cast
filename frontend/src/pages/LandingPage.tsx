      ...
      <Grid container spacing={4} justifyContent="center">
        <Grid item xs={12} md={6}>
          <StyledPaper onClick={handleCastingFiterClick}>
            ...
            <Typography variant="body1" color="text.secondary" align="center">
              Conduct AI-powered discussions with Valtechie(s) to find best fit to be casted to projects. Configure discussion parameters,
        ...
        <Grid item xs={12} md={6}>
          <StyledPaper>
            ...
            <Typography variant="body1" color="text.secondary" align="center">
              Analyze Valtechie profiles through an interactive chat interface.
